...
export default function Musicbox() {
    ...
    return (
        <Box sx={{
            ...
            <EndAdding open={saving} onClose={actions.endRecording} recording={currentRecording}
                       cancel={actions.endRecording}
                       save={save}/>
            <ListRecordings open={openRecordings} onClose={actions.closeListModal}
                            play={playFromRecording}/>

            {
                showUI ?
                    (
                        <DefaultMusicBox musicBox={musicBox} sounds={sounds} buttons={buttons}
                                         playSound={playSound}/>
                    ) : (
                        <Paper sx={{
                            width: "100%",
                            ...
                            <Box>
                                <Typography variant={'caption'} color={"text.secondary"}>Rotate your phone to landscape position</Typography>
                                <Box sx={{
                                    display: "flex",
                                    justifyContent: "center",
                                    alignItems: "center",
