import {Box, Button, ButtonGroup, Grid, Paper, Slider, Tooltip, Typography} from "@mui/material";
...
export default function Picshare() {
    ...
    function shareImage() {
        ...
        canvas.toBlob(async (blob) => {
            ...
            const sharedImage = await pocketbase.collection("sharedImages").create<{ image: string } & Record>(
                formData
            )


            const currentDomainAndHttp = window.location.href.split("/").slice(0, 3).join("/")
                ...
                hasFile ? (
                    <Box sx={{
                        ...
                        <Paper sx={{
                            ...
                            {file &&
                                <ImageEditor file={file} onChange={(canvas) => setCanvas(canvas)}
                        ...
                        <Grid sx={{
                            ...
                            <Grid item>
                                <Button component={"label"} endIcon={
                                    <Box sx={{
                                        height: "20px",
                                        width: "20px",
                                ...
                                <Box sx={{
                                    ...
                                    <Tooltip title={"Brush Size"}>
                                        <Slider value={brushSize}
                                                ...
                                                marks={sliderMarks} min={1} max={20}/>
                                    </Tooltip>
                                </Box>
                            </Grid>
                            <Grid item>
                                <Button component={"label"} variant={"outlined"} endIcon={
